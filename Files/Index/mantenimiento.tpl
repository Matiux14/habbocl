	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6" style="margin-top: 50px;">
								<a href="/" class="btn btn-danger" style="margin-left: 40%;">Hotel en mantenimiento</a>
							</div>
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6" style="margin-top: 10px;margin-left: 6%;">
				<p style="color: #FFF; line-height: 1;"><b>¿Cuando volvemos?<br>Estamos modificando muchas cosas, y puede tardar varios días </b></p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<p>El hotel por ahora esta cerrado, por favor vuelva más tarde</p>
			</div>
			<div class="col-md-6">
				<h3 class="box-title">Contacto con el personal</h3>
				<div class="box-content">
					<h4>Facebook</h4>
					<a href="https://fb.com/rick.holos/" class="light-link">Forbi</a>
