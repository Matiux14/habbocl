	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<?php 	global $db;
					$dd = $db->query("SELECT * FROM ranks WHERE id >= 3 AND id <= 4 ORDER BY id DESC");
			...
			<div class="col-md-6">
				...
				<div class="box-content">
					...
					<p>El equipo del hotel lleva placas especiales por las cuales podr&aacute;s reconocerlos. Ellos est&aacute;n aqu&iacute; para ayudarte en lo que necesites y si necesitas su ayuda solo debes buscarlos en alguna sala o contactarlos a trav&eacute;s de la consola o la herramienta de ayuda del hotel. <img style="float: right;" src="http://static.habbo-happy.net/img/articles/9e3f3c_AMB.gif" alt="" />
